...
class QueueRepository {
  ...
  Future<String> checkIn({
    ...
    try {
      ...
      await _firestore.doc(FirestorePaths.appointment(appointmentId)).update({
        'status': 'checked_in',
    ...
    try {
      ...
      if (status == 'completed') {
        ...
        if (appointmentId != null) {
          await _firestore.doc(FirestorePaths.appointment(appointmentId)).update({'status': 'completed'});
        }
      }
    } on FirebaseException catch (e) {
  ...
  Future<void> markSkipped({
    ...
    try {
      ...
      if (appointmentId != null) {
        await _firestore.doc(FirestorePaths.appointment(appointmentId)).update({'status': 'skipped'});
      }
    } on FirebaseException catch (e) {
